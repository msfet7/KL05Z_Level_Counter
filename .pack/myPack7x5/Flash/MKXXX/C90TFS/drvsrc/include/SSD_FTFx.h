...
#define FTFx_KX_512K_128K_4K_4K_4K        18   /* Kinetis - ARM Cortex M4 core K21/K22 100MHZ D-Flash*/
#define FTFx_KX_1024K_256K_4K_4K_4K       19   /* Kinetis - ARM Cortex M4 core K65/K66 180MHZ D-Flash*/
#define FTFx_KX_2048K_0K_16K_4K_0K        20   /* Kinetis - ARM Cortex M4 core K65/K66 180MHZ P-Flash*/
#define FTFx_KX_256K_256K_4K_4K_4K        21   // SDMDK-3432: Freescale K24F256 device support
...
/* Derivative selection */      // Added by ARM
...
#elif defined (MKP512X) || defined (MKD512) || defined (MKDIFR_120MHZ)
  ...
  #define FLASH_DERIVATIVE      FTFx_KX_2048K_0K_16K_4K_0K
#elif defined (MKP128_50MHZ) || defined (MKP64_50MHZ) || defined (MKPIFR_50MHZ) ||\
      defined (MKP32_50MHZ)  || defined (MKD32_50MHZ) || defined (MKDIFR_50MHZ) ||\
      defined (MKPIFR_48MHZ) || defined (MKP128_48MHZ)|| defined (MKP160_48MHZ) ||\
...
#elif defined (MKP256_50MHZ) || defined (MKD64_50MHZ) || defined (MKP256_48MHZ) /* CL 08.08.2012: K12/K12/K21/K22*/
  #define FLASH_DERIVATIVE      FTFx_KX_256K_64K_2K_1K_1K
#elif defined (MKD128_4KB_SECTOR)
  #define FLASH_DERIVATIVE      FTFx_KX_512K_128K_4K_4K_4K
#elif defined (MKD256_4KB_SECTOR)
  #define FLASH_DERIVATIVE      FTFx_KX_1024K_256K_4K_4K_4K
#elif defined (MKP256_4KB_SECTOR) || defined (MKP128_4KB_SECTOR) || defined (MKP64_4KB_SECTOR)  // SDMDK-3432: Freescale K24F256 device support
  #define FLASH_DERIVATIVE      FTFx_KX_256K_256K_4K_4K_4K
#else
...
typedef struct _ssd_config
{
...
#elif (FTFx_KX_256K_256K_4K_4K_4K == FLASH_DERIVATIVE)        // SDMDK-3432: Freescale K24F256 device support
    /* Endianness */
...
#elif ((FTFx_KX_512K_512K_16K_4K_4K == FLASH_DERIVATIVE) || (FTFx_KX_1024K_0K_16K_4K_0K == FLASH_DERIVATIVE) \
       || (FTFx_KX_2048K_0K_16K_4K_0K == FLASH_DERIVATIVE))
    /* Endianness */
    #define ENDIANNESS              LITTLE_ENDIAN
    ...
    #define RDRSRC_ALIGN_SIZE       FTFx_LONGWORD_SIZE      /* check align of read resource function */
    #define RDONCE_INDEX_MAX        0xF                     /* maximum index in read once command */  
#elif (FTFx_KX_512K_128K_4K_4K_4K == FLASH_DERIVATIVE)      /* 28.01.2013 CL K21/K22 100MHZ D-Flash*/
    /* Endianness */
    #define ENDIANNESS              LITTLE_ENDIAN
    ...
    #define DEPART_0001             0x00020000      /* Reserved */
    #define DEPART_0010             0x00020000      /* Reserved */
    #define DEPART_0011             0x00018000      /* 96 KB */
    #define DEPART_0100             0x00010000      /* 64 KB */
    #define DEPART_0101             0x00000000      /* 0 KB */
    #define DEPART_0110             0x00020000      /* Reserved */
    #define DEPART_0111             0x00020000      /* Reserved */
    #define DEPART_1000             0x00000000      /* 0 KB */
    #define DEPART_1001             0x00020000      /* Reserved */
    #define DEPART_1010             0x00020000      /* Reserved */
    #define DEPART_1011             0x00008000      /* 32 KB */
    #define DEPART_1100             0x00010000      /* 64 KB */
    #define DEPART_1101             0x00020000      /* 128 KB */
    #define DEPART_1110             0x00020000      /* Reserved */
...
#elif (FTFx_KX_1024K_256K_4K_4K_4K == FLASH_DERIVATIVE)     /* K65/K66 180MHZ D-Flash*/
    /* Endianness */
    #define ENDIANNESS              LITTLE_ENDIAN
    ...
    /* D/E-Flash Partition Code Field Description */
    #define DEPART_0000             0x00040000      /* 256 KB */
    #define DEPART_0001             0x00040000      /* Reserved */
    #define DEPART_0010             0x00040000      /* Reserved */
    #define DEPART_0011             0x00038000      /* 224 KB */
    #define DEPART_0100             0x00030000      /* 192 KB */
    #define DEPART_0101             0x00020000      /* 128 KB */
    #define DEPART_0110             0x00000000      /* 0 KB */
    #define DEPART_0111             0x00040000      /* Reserved */
    #define DEPART_1000             0x00000000      /* 0 KB */
    #define DEPART_1001             0x00040000      /* Reserved */
    #define DEPART_1010             0x00040000      /* Reserved */
    #define DEPART_1011             0x00008000      /* 32 KB */
    #define DEPART_1100             0x00010000      /* 64 KB */
    #define DEPART_1101             0x00020000      /* 128 KB */
    #define DEPART_1110             0x00040000      /* 256 KB */
    #define DEPART_1111             0x00040000      /* 256 KB */
...
extern UINT32 FlashReadResource(PFLASH_SSD_CONFIG PSSDConfig, \
      ...
      (FTFx_KX_512K_128K_4K_4K_4K == FLASH_DERIVATIVE) || (FTFx_KX_1024K_256K_4K_4K_4K == FLASH_DERIVATIVE) || (FTFx_KX_2048K_0K_16K_4K_0K == FLASH_DERIVATIVE))
...
extern UINT32 FlashProgramLongword(PFLASH_SSD_CONFIG PSSDConfig, \
        ...
        ||(FTFx_KX_2048K_0K_16K_4K_0K == FLASH_DERIVATIVE)||(FTFx_KX_1024K_256K_4K_4K_4K == FLASH_DERIVATIVE))
